...
const ProductCard = ({ imageSrc, ecomImageSrc, rating, ratingCount, title, description, price }) => {
  ...
  return (
    <div className='font-Satoshi product-card-outerdiv'>
      <div className=" product-card box-shadow relative bg-black/40 shadow-inner rounded-[15px] flex flex-col justify-between p-4" style={divStyle}>
